...
public class LTIv1p0ToolProvider extends LTIv1p0 implements LTIToolProvider{
    ...
    public LTIv1p0ToolProvider() {}
    
    public LTIv1p0ToolProvider(String endpoint, String key, String secret, Map<String, String> params) throws LTIException, Exception {
